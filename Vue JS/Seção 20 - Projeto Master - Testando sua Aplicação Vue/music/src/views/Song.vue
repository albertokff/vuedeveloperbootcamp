...
export default {
  ...
  data() {
    return {
      ...
      comment_alert_message: 'Por favor, aguarde! Seu comentário está sendo enviado.',
      comments: []
    }
  },
  computed: {
    ...
    sortedComments() {
      return this.comments.slice().sort((a, b) => {
        ...
        return new Date(a.datePoste) - new Date(b.datePosted)
      })
    }
  },
  ...
  methods: {
    ...
    async addComment(values, { resetForm }) {
      ...
      this.comment_alert_message = 'Por favor, aguarde! Seu comentário está sendo enviado.'
      ...
      this.comment_alert_message = 'Comentário adicionado!'
